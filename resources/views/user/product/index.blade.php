    ...
    <script>
        $(document).ready(function() {
            $('#products-table').DataTable({
                ...
                ajax: "{{ route('user.product.data') }}", // Using the custom route

                columns: [
                    {data: 'id',name: 'id',title: 'S.N.'},
                    {data: 'title',name: 'title',title: 'Title'},
                    {data: 'category',name: 'category',title: 'Category - Sub-category'},
                    {data: 'price',name: 'price',title: 'Price'},
                    {data: 'discount',name: 'discount',title: 'Discount'},
                    {data: 'condition',name: 'condition',title: 'Condition'},
                    {data: 'add_by',name: 'add_by',title: 'Add By'},
