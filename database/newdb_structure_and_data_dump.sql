...
INSERT INTO `categories` VALUES (3,'Electronics','electronics','Electronic items and gadgets','electronics.jpg',1,NULL,NULL,'active','2024-10-21 00:06:47','2024-10-21 00:06:47');
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `faculties_id` bigint unsigned DEFAULT NULL,
  `campus_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_email_unique` (`email`),
  UNIQUE KEY `users_student_id_unique` (`student_id`),
  KEY `users_faculties_id_foreign` (`faculties_id`),
  CONSTRAINT `users_faculties_id_foreign` FOREIGN KEY (`faculties_id`) REFERENCES `faculties` (`id`) ON DELETE CASCADE
...
INSERT INTO `users` VALUES (1,'Admin','admin@gmail.com',NULL,NULL,'$2y$10$GcfSBQrEGZMPxMmAPxIlWuyGoAjq9ONgC4edSqS7H7iRIY4K1cumi',NULL,'admin',NULL,NULL,'active',NULL,NULL,NULL,NULL,NULL),(2,'User','user@gmail.com',NULL,NULL,'$2y$10$x1rZEA8vCMy32nCOwCLKP.ALoVnN/j5eu5nYE6ORkfNw644kldC1O',NULL,'user',NULL,NULL,'active',NULL,NULL,NULL,NULL,NULL),(3,'jia','jia@gmail.com',NULL,NULL,'$2y$10$WaIK4yNZsqODi/NA.ZJsAeF63ivRVKTRnuFc8h9UIeBqCUVo5578S',NULL,'user',NULL,NULL,'active',NULL,'2024-10-21 07:40:00','2024-10-21 07:40:00',NULL,NULL);
...
-- Dump completed on 2024-10-21 23:54:54
